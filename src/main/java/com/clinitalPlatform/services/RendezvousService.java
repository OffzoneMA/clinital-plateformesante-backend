...
//	private UrlVideoCallGenerator urlVideoCallGenerator;
	...
	public void UpdateRdvByIdPatient(FichePatientResponse.RendezvousRequest req, long id) throws Exception{
	...
	public void UpdateRdvByIdMedecin(FichePatientResponse.RendezvousRequest req, long id, long idMed) throws Exception{
		DayOfWeek day = DayOfWeek.valueOf(req.getDay());
	...
	public ResponseEntity<?> UpdateRdvdate(FichePatientResponse.RendezvousRequest req, long id) throws Exception{
		//DayOfWeek day = DayOfWeek.valueOf(req.getDay());
