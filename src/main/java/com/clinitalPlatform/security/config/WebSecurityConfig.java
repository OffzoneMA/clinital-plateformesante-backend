...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        String[] authenticatedRoutes = {"/api/demandes/**", "/api/doc/**", "/api/shares/**","/api/rdv/patient/**","/api/rdv/patient/rdvById/**","/api/rdv/MoveRdv/**","/api/rdv/patient/updateRdv/**","/api/rdv/patient/updateeRdv/{id}","/api/rdv/patient/cancelRdv/**","/api/rdv/patient/rdvbyday","/api/rdv/patient/rdvbyday/**","/api/rdv/patient/changestatu/**"};
